package UF3.LlegirNotesMarca;
import java.io.File;
import java.util.Scanner;

public class LlegirNotesMarca {
    //la paraula fi serveix com a marca de final de fitxer
    public static final String MARCA_FI = "fi";
    public static final int a = -1;
    public static void main (String[] args) {
        LlegirNotesMarca programa = new LlegirNotesMarca();
        programa.inici();
    }
    public void inici() {
        try {
            File f = new File("C:\\Users\\aleix\\Programacio\\CodiwithMarina2023\\src\\UF3\\LlegirNotesMarca\\NotesMarca.txt");
